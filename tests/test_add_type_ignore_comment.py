...
def test_should_add_new_error_codes(final_comment: str):
...
def test_should_place_type_ignore_comment_first(final_comment: str):
    assert final_comment.startswith("# type: ignore")


def test_should_sort_error_codes(final_comment: str):
...
def test_should_not_add_duplicate_error_codes(final_comment: str):
